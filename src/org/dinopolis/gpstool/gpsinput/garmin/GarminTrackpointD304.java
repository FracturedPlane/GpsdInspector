/***********************************************************************
 * @(#)$RCSfile: GarminTrackpointD304.java,v $   $Revision: 1.1 $$Date: 2007/03/30 08:50:59 $
 *
...
//----------------------------------------------------------------------
/**
 * This class represents packets in Garmin data format D304.
 *
 * @author Sandra Brueckler, Stefan Feitl, Massimo Nervi
 * @version $Revision: 1.1 $
 */

public class GarminTrackpointD304 implements GarminTrackpoint
{
  public int display_;
  ...
  protected final static int TRACKPOINT_TYPE = 304;
  
  public GarminTrackpointD304()
  {
  }

  public GarminTrackpointD304(int[] buffer)
  {
  ...
  public GarminTrackpointD304(GarminPacket pack)
  {
//    valid_position= pack.getLongWord(0)!=0x7FFFFFFF;
  ...
  public GarminTrackpointD304(GPSTrackpoint trackpoint)
  {
 ...
 */
  ...
  public String toString()
  {
   ...
   //----------------------------------------------------------------------
/**
 * Is this a valid trackpoint?
 * From Garmin specs:
 *   The "posn" member is invalid if both lat and lon are equal to 0x7FFFFFFF.
  * @return True if this trackpoint has valid position
 */

  public boolean has_valid_position(){
      //FIXXME use a field, set the value in the constructor
      return (Math.abs(longitude_)>1  &&   Math.abs(longitude_)<89) ;
  }
